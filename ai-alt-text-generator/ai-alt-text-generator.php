 ...
 * Description:       Automatically generate descriptive, accessible alt text for your images using AI (OpenAI or Anthropic) — improving accessibility compliance and SEO.
 * Version:           2.5.3
 * Author:            migkapa
...
define( 'AATG_TEXT_GENERATOR_VERSION', '2.5.3' );
